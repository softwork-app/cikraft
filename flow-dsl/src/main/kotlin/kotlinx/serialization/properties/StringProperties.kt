...
// Copied from: https://github.com/Kotlin/kotlinx.serialization/blob/100dd538ac42f145db88c1130f3ee27675e412f5/formats/properties/commonMain/src/kotlinx/serialization/properties/StringProperties.kt
// Licence: Apache-2
// Reason: https://github.com/Kotlin/kotlinx.serialization/issues/1152
...
public sealed class StringProperties(
    ...
    public override fun <T> encodeToString(serializer: SerializationStrategy<T>, value: T): String {
        ...
        return encodeMapToString(map)
    }

    /**
     * Encodes properties from the given [map] to a properties String.
     * `null` values are omitted from the output.
     */
    @ExperimentalSerializationApi
    public fun encodeMapToString(map: Map<String, Any>): String {
     ...
     */
    public fun decodeMapFromString(string: String): Map<String, String> {
    ...
    public override fun <T> decodeFromString(deserializer: DeserializationStrategy<T>, string: String): T {
        val result = decodeMapFromString(string)
...
public class StringPropertiesBuilder internal constructor(from: PropertiesConf) {
    ...
    internal fun build(): PropertiesConf = PropertiesConf(
        lineSeparator,
        keyValueSeparator,
...
public enum class LineSeparator(private val s: String) {
    ...
    public fun chars(): CharArray = s.toCharArray()
}
